# encoding=utf8
from utils.RheeTypeCheck import RheeTypeCheck
...
class UnitInterpreter(RheeTypeCheck):
    ...
    def i_forloop(self, tree, env):
        ...
        refDummy = ("bogus", tree[1], [tree[2], ]) if tree[2][0] != 'reference' else tree[
            2]  # Create ast like reference <laziness>
    ...
    def i_functioncall(self, tree, env, depth=-1, globalenv=None):
        ...
        if fvalue == 'undefined':
            if self.checklibrary(fname):
                return self.call(fname, args, env)
