...
u'''क = "यो एउटा स्त्रिंग हो एस्लाई हामी टेस्ट गर्दैछौ"
गन(क) लेख
अंक("-९०e-४") लेख
टुक्राउ(क, " ") लेख
खोज(क, "एउटा") लेख
बद्ल(क, "एउटा", "केवल") लेख
खालीहताऊ("     टेस्ट    ") लेख
प्रकार(४) लेख
प्रकार("तेस") लेख
प्रकार(क) लेख
''',		# lib functions string
u'''
खाका टेस्ट
	क = [४,५,६,७,८]
	काम रचना()
...
वर्गमूल(९) लेख
''',				# math functions
u'''क = फाइलखोल("C:\\Users\\Sushil\\Desktop\\टेस्ट2.rhee", "जोड्न")
क मा "यो टेस्ट हो " लेख;
क बन्दगर
''',			#file
